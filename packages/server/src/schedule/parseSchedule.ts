...
export default function (html: string, group?: string): Schedule | undefined {
    try {
        ...
        const subgroup = withSubgroups ? group?.split("(")[1].replace(")", "") : undefined
        ...
        const originalSchedule = html
            ...
            .map((x) => ({
                ...
                schedule: x
                    ...
                    .toSpliced(0, 1)
                    .map((lesson) => ({
                        number: parseInt(lesson.split("</th")[0].split("th>")[1].trim()),
            ...
            .map((x) => {
                ...
                return {
                    ...
                    schedule: x
                        ...
                        .toSpliced(0, 1)
                        .map((lesson) => {
                            const number = parseInt(lesson.split("</th")[0].split("th>")[1].trim())
